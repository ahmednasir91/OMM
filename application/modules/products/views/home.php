...
<div class="container">
    ...
    <div id="about">
        ...
        <p style="text-align:justify;"><b><font color="#121212">Welcome to OMM!</font></b> OMM is a
            global Online Market Place for all brands. OMM is popular for publishing product reviews
            and detailed stats on old and latest mobile handsets. Our directory has listed more than
            33,000 used mobile brands with all details related to their prices, seller info, age and
            more. We connect sellers with buyers and thats what we have been enjoying doing
            successfully for over three years.</p>
    ...
    <div id="recent-posts">
        ...
        <div class="r-post clearfix">
            <div class="thumb">
                <a href="/products/show/<? echo $product["id"] ?>">
                    <img src="<? echo $product["thumb_url"] ?>" class='r-post-image' alt='dummy'
            ...
            <!-- end .thumb -->
            <h4 class="title"><a
                href="/products/show/<? echo $product["id"] ?>"><? echo $product["make"] . " " . $product["model_no"] ?></a>
            </h4>
        ...
        <a href="/products" class="readmore"><span>More Products</span></a>
